-- Выполните эти команды ПО ОДНОЙ в psql
-- Каждую команду нажимайте Enter после завершения

-- 1. Удалить таблицу
DROP TABLE IF EXISTS turn CASCADE;

-- 2. Создать таблицу (скопируйте ВСЮ команду от CREATE до ;)
CREATE TABLE turn (
...
-- 3. Создать индексы (выполните каждую команду отдельно)
