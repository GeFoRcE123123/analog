#!/usr/bin/env python3
"""
Тест Debian парсера в изоляции
...
def test_debian_minimal():
    """Минимальный тест Debian парсера - 1-10 CVE"""
    ...
    try:
        print("🔍 Инициализация Debian парсера...")
        
        html_parser = HTMLVulnerabilityParser()
        limit = int(os.getenv("DEBIAN_LIMIT", "10"))
        
        print(f"📥 Парсинг {limit} CVE из Debian Security Tracker...")
        
        vulnerabilities = html_parser.parse_source("debian", limit=limit)
