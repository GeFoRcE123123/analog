#!/usr/bin/env python3
"""
Тест Ubuntu парсера в изоляции
...
def test_ubuntu_minimal():
    """Минимальный тест Ubuntu парсера - 1-10 CVE"""
    ...
    try:
        print("🔍 Инициализация Ubuntu парсера...")
        
        html_parser = HTMLVulnerabilityParser()
        limit = int(os.getenv("UBUNTU_LIMIT", "10"))
        
        print(f"📥 Парсинг {limit} CVE из Ubuntu Security Tracker...")
